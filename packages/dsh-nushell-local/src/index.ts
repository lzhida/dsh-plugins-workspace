...
/**
 * dsh-nushell-local:本地 Nushell shell executor,经 `ctx.subprocess` 委托
 * 执行,向宿主注入 `ctx.shell` 能力——nushell 以一等 shell 身份进入官方
 * shell 家族(与 dsh-pwsh-local 对 PowerShell 的角色一致)。前台/后台执行、
